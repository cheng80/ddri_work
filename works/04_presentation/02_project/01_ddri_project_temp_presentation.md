...
<ul class="compact-list">
  ...
  <li>같은 대여소로 5분 이내 반납된 건은 제거하고, 그 외 기록은 재고 변동성 해석용 지표 후보로 유지</li>
</ul>
...
<ul class="compact-list">
  <li>학습 데이터 기준 self-return 비율 평균: `8.49%`</li>
  <li>테스트 데이터 기준 self-return 비율 평균: `9.12%`</li>
  <li>같은 대여소 5분 이내 반납은 제거하고, 그 외 기록은 재고 변동성 해석용 보조 지표로 유지</li>
